...
export const searchIndexes: SearchIndexItem[] = [
	{
		...
		children: [
			...
			{
				id: '51TBiPcmy',
				label: i18n.ts._timelines.media,
				keywords: ['enable', 'media'],
			},
			{
				id: 'eJmNR2K4s',
	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				keywords: ['bot', 'careful', i18n.ts.carefulBotDescription],
			},
			{
				id: '5hAiPsvL6',
			...
			{
				id: 'Av7fAaHv8',
				label: i18n.ts._isIndexable.title,
				keywords: ['privacy', 'indexable', i18n.ts._isIndexable.description],
			},
			{
				id: 'sMmYFCS60',
				children: [
	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				keywords: ['default', 'search', 'privacy'],
			},
			{
				id: 'wRpIPnyzi',
				children: [
	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				keywords: ['hotkey', 'enable', 'enter'],
			},
			{
				id: 'qBKqephVl',
				label: 'Unnamed marker',
				keywords: ['hotkey', 'enable', 'shift', 'enter'],
			},
			{
				id: 'eEA7ytlZ5',
			...
			},
			{
				...
				children: [
					...
					},
					{
						...
						keywords: ['ticker', 'information', 'label', 'instance', 'server', 'host', 'federation', 'note'],
					},
					{
						id: 'saHIrDljc',
