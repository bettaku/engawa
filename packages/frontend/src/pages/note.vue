			...
			<Transition :name="prefer.s.animation ? 'fade' : ''" mode="out-in">
				<div v-if="note">
					<div v-if="showNext" class="_margin">
						<MkNotes class="" :pagination="nextUserPagination" :noGap="!prefer.s.showGapBetweenNotesInTimeline" :disableAutoLoad="true"/>
					</div>
					...
					<div v-if="showPrev" class="_margin">
						<MkNotes class="" :pagination="prevUserPagination" :noGap="!prefer.s.showGapBetweenNotesInTimeline"/>
					</div>
				</div>
