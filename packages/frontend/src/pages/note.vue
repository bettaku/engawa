			...
			<Transition :name="defaultStore.state.animation ? 'fade' : ''" mode="out-in">
				<div v-if="note">
					<div v-if="showNext" class="_margin">
						<MkNotes class="" :pagination="nextUserPagination" :noGap="!defaultStore.state.showGapBetweenNotesInTimeline" :disableAutoLoad="true"/>
					</div>
					...
					<div v-if="showPrev" class="_margin">
						<MkNotes class="" :pagination="prevUserPagination" :noGap="!defaultStore.state.showGapBetweenNotesInTimeline"/>
					</div>
				</div>
