				...
				<SearchMarker v-slot="slotProps" :keywords="['information', 'meta']">
					<MkFolder :defaultOpen="true">
						...
						<div class="_gaps">
							...
							<SearchMarker :keywords="['status']">
								<MkInput v-model="infoForm.state.statusUrl" type="url">
									<template #label><SearchLabel>{{ i18n.ts.statusUrl }}</SearchLabel><span v-if="infoForm.modifiedStates.statusUrl" class="_modified">{{ i18n.ts.modified }}</span></template>
