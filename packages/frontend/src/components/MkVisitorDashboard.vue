	...
	<div :class="[$style.main, $style.panel]">
		...
		<div :class="$style.mainFg">
			...
			<div class="_gaps_s" :class="$style.mainActions">
				<MkButton :class="$style.mainAction" full rounded gradate data-e2e-signup style="margin-right: 12px;" @click="signup()">{{ i18n.ts.joinThisServer }}</MkButton>
				...
				<MkButton :class="$style.mainAction" full rounded data-e2e-signin @click="signin()">{{ i18n.ts.login }}</MkButton>
			</div>
		</div>
	</div>
