...
<div>
	...
	<div class="_spacer" style="--MI_SPACER-min: 20px; --MI_SPACER-max: 32px;">
		<form class="_gaps_m" autocomplete="new-password" @submit.prevent="onSubmit">
			<MkInput v-if="instance.disableRegistration" v-model="invitationCode" type="text" :spellcheck="false" required data-e2e-signup-invitation-code>
				<template #label>{{ i18n.ts.invitationCode }}</template>
				<template #prefix><i class="ti ti-key"></i></template>
			</MkInput>
			<MkInput v-model="username" type="text" pattern="^[a-zA-Z0-9_]{1,20}$" :spellcheck="false" autocomplete="username" required data-e2e-signup-username @update:modelValue="onChangeUsername">
			...
			<MkInput v-if="instance.emailRequiredForSignup" v-model="email" :debounce="true" type="email" :spellcheck="false" required data-e2e-signup-email @update:modelValue="onChangeEmail">
			...
			<MkInput v-model="password" :type="showPassword ? 'text' : 'password'" autocomplete="new-password" required data-e2e-signup-password @update:modelValue="onChangePassword" @keydown="checkCapsLock" @focus="checkCapsLock" @click="checkCapsLock">
			...
			<MkInput v-model="retypedPassword" :type="showPassword2 ? 'text' : 'password'" autocomplete="new-password" required data-e2e-signup-password-retype @update:modelValue="onChangePasswordRetype" @keydown="checkCapsLock" @focus="checkCapsLock" @click="checkCapsLock">
			...
			<div class="_buttonsCenter">
				...
				<MkButton type="submit" :disabled="shouldDisableSubmitting" inline gradate rounded data-e2e-signup-submit style="margin: 0 auto;">
