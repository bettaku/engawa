				...
				<div :class="$style.centerPage">
					...
					<div class="_spacer" style="--MI_SPACER-min: 20px; --MI_SPACER-max: 28px;">
						<div class="_gaps" style="text-align: center;">
							...
							<MkButton primary rounded gradate style="margin: 16px auto 0 auto;" data-e2e-user-setup-continue @click="page++">{{ i18n.ts._initialAccountSetting.profileSetting }} <i class="ti ti-arrow-right"></i></MkButton>
					...
					<div :class="$style.pageRoot">
						...
						<div :class="$style.pageFooter">
							<div class="_buttonsCenter">
								...
								<MkButton primary rounded gradate data-e2e-user-setup-continue @click="page++">{{ i18n.ts.continue }} <i class="ti ti-arrow-right"></i></MkButton>
							</div>
						</div>
					</div>
				</div>
