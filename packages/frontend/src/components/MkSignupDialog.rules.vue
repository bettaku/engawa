	...
	<div class="_spacer" style="--MI_SPACER-min: 20px; --MI_SPACER-max: 28px;">
		<div class="_gaps_m">
			...
			<MkFolder :defaultOpen="true">
				...
				<MkSwitch :modelValue="agreeNote" style="margin-top: 16px;" data-e2e-signup-rules-notes-agree @update:modelValue="updateAgreeNote">{{ i18n.ts.agree }}</MkSwitch>
			</MkFolder>
			...
			<div class="_buttonsCenter">
				...
				<MkButton inline primary rounded gradate :disabled="!agreed" data-e2e-signup-rules-continue @click="emit('done')">{{ i18n.ts.continue }} <i class="ti ti-arrow-right"></i></MkButton>
			</div>
		</div>
	</div>
</div>
