...
<template>
<div :class="$style.wrapper" data-e2e-signin-page-password>
	<div class="_gaps" :class="$style.root">
		...
		<form class="_gaps_s" @submit.prevent="onSubmit">
			...
			<MkInput v-model="password" :placeholder="i18n.ts.password" :type="showPassword ? 'text' : 'password'" autocomplete="current-password webauthn" :withPasswordToggle="true" required autofocus data-e2e-signin-password @enter.prevent="onSubmit" @keydown="checkCapsLock" @focus="checkCapsLock" @click="checkCapsLock">
			...
			<div class="_buttonsCenter">
				...
				<MkButton type="submit" :disabled="needCaptcha && captchaFailed" inline primary rounded data-e2e-signin-page-password-continue>{{ i18n.ts.continue }} <i class="ti ti-arrow-right"></i></MkButton>
			</div>
		</form>
	</div>
</div>
