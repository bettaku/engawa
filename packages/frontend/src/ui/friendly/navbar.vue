...
<div :class="[$style.root, { [$style.iconOnly]: iconOnly }]">
	<div :class="$style.body">
		...
		<div :class="$style.bottom">
			...
			<button v-tooltip.noDelay.right="prefer.s.renameTheButtonInPostFormToNya ? i18n.ts.nya : i18n.ts.note" class="_button" :class="[$style.post]" data-e2e-open-post-form @click="() => { os.post(); }">
