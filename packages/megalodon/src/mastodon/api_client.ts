...
namespace MastodonAPI {
	...
	export namespace Converter {
		...
		): MegalodonEntity.Announcement => a;
		export const application = (
			a: Entity.Application,
		): MegalodonEntity.Application => a;
		export const attachment = (
			a: Entity.Attachment,
		): MegalodonEntity.Attachment => a;
		...
		export const context = (c: Entity.Context): MegalodonEntity.Context => ({
			ancestors: Array.isArray(c.ancestors)
				? c.ancestors.map((a) => status(a))
				: [],
			descendants: Array.isArray(c.descendants)
				? c.descendants.map((d) => status(d))
				: [],
		});
		...
		export const featured_tag = (
			e: Entity.FeaturedTag,
		): MegalodonEntity.FeaturedTag => e;
		...
		export const identity_proof = (
			i: Entity.IdentityProof,
		): MegalodonEntity.IdentityProof => i;
		export const instance = (i: Entity.Instance): MegalodonEntity.Instance => i;
		export const list = (l: Entity.List): MegalodonEntity.List => l;
		export const marker = (
			m: Entity.Marker | Record<never, never>,
		): MegalodonEntity.Marker | Record<never, never> => m;
		...
		export const poll_option = (
			p: Entity.PollOption,
		): MegalodonEntity.PollOption => p;
		export const preferences = (
			p: Entity.Preferences,
		): MegalodonEntity.Preferences => p;
		export const push_subscription = (
			p: Entity.PushSubscription,
		): MegalodonEntity.PushSubscription => p;
		export const relationship = (
			r: Entity.Relationship,
		): MegalodonEntity.Relationship => r;
		...
		export const status_params = (
			s: Entity.StatusParams,
		): MegalodonEntity.StatusParams => s;
		export const status_source = (
			s: Entity.StatusSource,
		): MegalodonEntity.StatusSource => s;
