...
pub(crate) struct ServerConfig {
    ...
    pub meilisearch: Option<MeilisearchConfig>,
		...
		// ID generation type config
		pub id: String,

		// Error tracking
		pub sentry_for_backend: Option<SentryBackendConfig>,
		pub sentry_for_frontend: Option<SentryFrontendConfig>,
}
...
#[derive(Deserialize, Serialize, Debug)]
#[serde(rename_all = "camelCase")]
pub(crate) struct SentryBackendConfig {
...
#[derive(Deserialize, Serialize, Debug)]
#[serde(rename_all = "camelCase")]
pub(crate) struct SentryFrontendConfig {
	pub options: Option<SentryOptions>,
}

#[derive(Deserialize, Serialize, Debug)]
#[serde(rename_all = "camelCase")]
pub(crate) struct SentryOptions {
	pub dsn: String,
}
