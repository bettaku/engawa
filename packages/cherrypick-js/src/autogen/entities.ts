...
export type AdminIndexFullRequest = operations['admin___index___full']['requestBody']['content']['application/json'];
export type AdminIndexReindexRequest = operations['admin___index___reindex']['requestBody']['content']['application/json'];
...
export type AdminSetUserSensitiveRequest = operations['admin___set-user-sensitive']['requestBody']['content']['application/json'];
export type AdminUnsetUserSensitiveRequest = operations['admin___unset-user-sensitive']['requestBody']['content']['application/json'];
