...
import type { FollowingsRepository, NotesRepository, EmojisRepository, NoteReactionsRepository, UserProfilesRepository, UserNotePiningsRepository, UsersRepository, FollowRequestsRepository, MiMeta, MiUserPublickey, ChatMessagesRepository } from '@/models/_.js';
...
import { IActivity, ICreate, IAnnounce } from '@/core/activitypub/type.js';
...
export class ActivityPubServerService {
	 ...
	 */
	@bindThis
	private async packActivity(note: MiNote): Promise<ICreate | IAnnounce> {
