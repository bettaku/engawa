...
pub struct Model {
    ...
    #[sea_orm(column_name = "bubbleInstances")]
    pub bubble_instances: Vec<String>,
    ...
    #[sea_orm(column_name = "useRemoteObjectStorage")]
    pub use_remote_object_storage: bool,
    #[sea_orm(column_name = "remoteObjectStorageBucket")]
    pub remote_object_storage_bucket: Option<String>,
    #[sea_orm(column_name = "remoteObjectStoragePrefix")]
    pub remote_object_storage_prefix: Option<String>,
    #[sea_orm(column_name = "remoteObjectStorageBaseUrl")]
    pub remote_object_storage_base_url: Option<String>,
    #[sea_orm(column_name = "remoteObjectStorageEndpoint")]
    pub remote_object_storage_endpoint: Option<String>,
    #[sea_orm(column_name = "remoteObjectStorageRegion")]
    pub remote_object_storage_region: Option<String>,
    #[sea_orm(column_name = "remoteObjectStorageAccessKey")]
    pub remote_object_storage_access_key: Option<String>,
    #[sea_orm(column_name = "remoteObjectStorageSecretKey")]
    pub remote_object_storage_secret_key: Option<String>,
    #[sea_orm(column_name = "remoteObjectStoragePort")]
    pub remote_object_storage_port: Option<i32>,
    #[sea_orm(column_name = "remoteObjectStorageUseSSL")]
    pub remote_object_storage_use_ssl: Option<bool>,
    #[sea_orm(column_name = "remoteObjectStorageUseProxy")]
    pub remote_object_storage_use_proxy: Option<bool>,
    #[sea_orm(column_name = "remoteObjectStorageSetPublicRead")]
    pub remote_object_storage_set_public_read: bool,
    #[sea_orm(column_name = "remoteObjectStorageS3ForcePathStyle")]
    pub remote_object_storage_s3_force_path_style: bool,
    #[sea_orm(column_name = "youBlockedImageUrl")]
    pub you_blocked_image_url: Option<String>,
    #[sea_orm(column_name = "disableRegistrationWhenInactive")]
    pub disable_registration_when_inactive: bool,
    #[sea_orm(column_name = "disablePublicNoteWhenInactive")]
    pub disable_public_note_when_inactive: bool,
    #[sea_orm(column_name = "moderatorInactivityLimitDays")]
    pub moderator_inactivity_limit_days: i32,
    #[sea_orm(column_name = "libreTranslateEndPoint")]
    pub libre_translate_end_point: Option<String>,
    #[sea_orm(column_name = "libreTranslateApiKey")]
    pub libre_translate_api_key: Option<String>,
    #[sea_orm(column_name = "robotsTxt")]
    pub robots_txt: Option<String>,
    #[sea_orm(column_name = "customRobotsTxt")]
    ...
    #[sea_orm(column_name = "deliverSuspendedSoftware", column_type = "JsonBinary")]
    pub deliver_suspended_software: Json,
    #[sea_orm(column_name = "enableAuthorizedFetch")]
    pub enable_authorized_fetch: bool,
    #[sea_orm(column_name = "enableBotProtectionForAuthorizedFetch")]
    pub enable_bot_protection_for_authorized_fetch: bool,
}
